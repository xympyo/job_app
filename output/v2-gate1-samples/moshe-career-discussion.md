...
Use supplied evidence to explore career direction. Ask focused questions where material facts are missing.
...
> What career direction fits my evidence?
...
- Help the user think through career direction using the supplied evidence and identify useful next questions.
...
{
  "contentHash": "fnv1a64:0f3bea4c1352ff52",
  "excludedSections": [
    "jobs",
    "applications",
    "applicationAnswers",
