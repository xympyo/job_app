...
- Pack ID: sample-moshe-triage-jobs
...
[
  ...
  },
  {
    ...
    "location": "Cikarang",
    "postingStatus": "Verified open",
    "reviewStatus": "Ready to Apply",
    "roleFamily": "Product",
    "sources": [
      {
        "sourceName": "Company careers",
        "sourceType": "Official careers",
        "sourceUrl": "https://example.invalid/jobs/2"
      }
    ],
...
- Recommend a ranked queue from the selected jobs. Recommendations are not user decisions.
...
- Result kind: triage_result

- Required fields: [source.pack_id], [triage_run.researched_at], [decisions[].job_id], [decisions[].decision], [decisions[].reason]
...

{
  "decisions": [
    {
      "decision": "Apply ASAP|Apply|Research First|Skip",
      "job_id": "<existing job id>",
      "reason": "<evidence-grounded reason>",
      "recommendation": "<same decision>",
      "recommended_cv": "<variant name>",
      "review_status": "Ready to Apply|Reviewing|Skipped",
      "verification_note": "<what was checked>"
    }
  ],
  "source": {
    "pack_id": "sample-moshe-triage-jobs",
    "task": "triage_jobs"
  },
  "triage_run": {
    "notes": "<notes>",
...
{
  "contentHash": "fnv1a64:0702266afc6fdce3",
  "excludedSections": [
    "unrelatedJobs",
    "applicationAnswers",
    "documentContent"
